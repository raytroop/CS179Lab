...
/*************** END GAUSSIAN ******************/
    ...
    cudaMalloc((void **) &dev_input_data, padded_length
        * sizeof(cufftComplex));
    cudaMalloc((void **) &dev_impulse_v, padded_length
        * sizeof(cufftComplex));
    cudaMalloc((void **) &dev_out_data, padded_length
        * sizeof(cufftComplex));
...
#define STOP_RECORD_TIMER(name) {                           \
    ...
    for (int ch = 0; ch < nChannels; ch++){
        ...
        cudaMemset(dev_input_data, 0, padded_length
            * sizeof(cufftComplex));
        cudaMemcpy(dev_input_data, input_data, N * sizeof(cufftComplex),
        ...
        */
        cudaMemset(dev_impulse_v, 0, padded_length
            * sizeof(cufftComplex));
        cudaMemcpy(dev_impulse_v, impulse_data, impulse_length
        ...
        */
        cufftHandle plan;
        cufftPlan1d(&plan, padded_length, CUFFT_C2C, 1); // 1 transformation
